...
<head>
   ...
   <link rel="icon" href="./imagenes/farmacias.png">
...
<section class="accounts">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" class="delete-btn" onclick="return confirm('¿borrar esta cuenta?');">Borrar</a>
         <?php
