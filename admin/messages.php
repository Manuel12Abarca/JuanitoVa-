...
<section class="messages">
   ...
   <div class="box">
      ...
      <p> numero telefónico : <span><?= $fetch_messages['number']; ?></span> </p>
      <p> email : <span><?= $fetch_messages['email']; ?></span> </p>
      <p> mensaje : <span><?= $fetch_messages['message']; ?></span> </p>
      <a href="messages.php?delete=<?= $fetch_messages['id']; ?>" class="delete-btn" onclick="return confirm('eliminar este mensaje?');">borrar</a>
   </div>
   <?php
         }
      }else{
