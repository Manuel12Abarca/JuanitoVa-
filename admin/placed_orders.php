...
<section class="placed-orders">
   ...
   <div class="box">
      ...
      <p> número telefónico : <span><?= $fetch_orders['number']; ?></span> </p>
      ...
      <form action="" method="POST">
         ...
         <div class="flex-btn">
            ...
            <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('eliminar esta orden?');">eliminar</a>
         </div>
      </form>
   </div>
   <?php
